...
| Snapshot shortcuts | F5=`vm-20260704032357`, F6=`vm-20260704034933` under `[general.snapshots.shortcuts]` | `grep -n 'f5 = ' "$HOME/Library/Application Support/xemu/xemu/xemu.toml"` — or list ALL snapshots in the image with the qcow2 snapshot lister (xemu-diagnostics-and-tooling) |
